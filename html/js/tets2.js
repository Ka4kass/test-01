document.addEventListener('DOMContentLoaded', function() {
    ...
    const cities = [
        { name: "München", product: "München", price: 34, description: "München – eine Stadt mit einer reichen architektonischen Palette, in der gotische Kathedralen, barocke Paläste und Bauten der Neorenaissance harmonisch mit Bereichen moderner Architektur verschmelzen. Ihre Straßen und Plätze bewahren die Atmosphäre der Geschichte, ergänzt durch den lebendigen Rhythmus des modernen Lebens.", scale: "1:4500", parts: 90, size: "18x18", region: "Hamburg", image: "./img/5.png",liste:"./img/25.png" },
